package org.wildfly.apigen.test.invocation.logging.subsystem.loggingProfile.sizeRotatingFileHandler;
 ...
 */
@Address("/subsystem=logging/logging-profile=*/size-rotating-file-handler=*")
